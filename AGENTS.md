...
Phase 0–4 están documentadas e implementadas. La dirección oficial es **Hybrid — Apex + Engineered Clarity** dentro de un único Design System, nunca dos temas o sistemas paralelos. Principio rector: **Expressive where emotion matters. Precise where decisions matter.** Phase 5 está READY; cyan `#00B7E5` y Barlow Condensed + Inter siguen provisionales y deben permanecer reemplazables mediante tokens hasta validación del cliente.
