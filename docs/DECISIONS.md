...
Phase 0–6 están implementadas bajo ADR-001–072. Phase 7 requiere brief/aprobación específicos. Cliente/ventas aún deben aportar catálogo y specs autorizados, datos de Location, workflows/SLA, fuente de precios, CRM, branding y derechos; ver `OPEN_QUESTIONS.md`. El tratamiento final de cada URL legacy se valida con tráfico/backlinks y status del modelo, sin reabrir ADR-027.
